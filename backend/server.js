...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["Data.Zipper.ArrayZipper"] = $PS["Data.Zipper.ArrayZipper"] || {};
  var exports = $PS["Data.Zipper.ArrayZipper"];
  var Data_Array = $PS["Data.Array"];
  var Data_Boolean = $PS["Data.Boolean"];
  var Data_Maybe = $PS["Data.Maybe"];
  var toArrayZipperFirst = function (v) {
      if (v.length === 0) {
          return Data_Maybe.Nothing.value;
      };
      return new Data_Maybe.Just({
          array: v,
          focusIndex: 0,
          maxIndex: Data_Array.length(v) - 1 | 0
      });
  };
  var shiftFocusLast = function (v) {
      return {
          array: v.array,
          focusIndex: v.maxIndex,
          maxIndex: v.maxIndex
      };
  };
  var shiftFocusFirst = function (v) {
      return {
          array: v.array,
          focusIndex: 0,
          maxIndex: v.maxIndex
  ...
  var prev = function (v) {
      if ((v.focusIndex - 1 | 0) >= 0) {
          return new Data_Maybe.Just({
              array: v.array,
              focusIndex: v.focusIndex - 1 | 0,
              maxIndex: v.maxIndex
          });
      };
      if (Data_Boolean.otherwise) {
      ...
      throw new Error("Failed pattern match at Data.Zipper.ArrayZipper (line 217, column 1 - line 217, column 57): " + [ v.constructor.name ]);
  };
  var next = function (v) {
      if ((v.focusIndex + 1 | 0) <= v.maxIndex) {
          return new Data_Maybe.Just({
              array: v.array,
              focusIndex: v.focusIndex + 1 | 0,
              maxIndex: v.maxIndex
      ...
      throw new Error("Failed pattern match at Data.Zipper.ArrayZipper (line 225, column 1 - line 225, column 57): " + [ v.constructor.name ]);
  };
  var getFocus = function (v) {
      return v["array"][v.focusIndex];
  };
  exports["toArrayZipperFirst"] = toArrayZipperFirst;
  exports["prev"] = prev;
  exports["next"] = next;
  exports["shiftFocusFirst"] = shiftFocusFirst;
  exports["shiftFocusLast"] = shiftFocusLast;
...
(function($PS) {
  ...
  var at = function (dictMonoid) {
      return function (dictLookup) {
          return function (set) {
              var $3 = Data_Maybe.fromMaybe(Data_Monoid.mempty(dictMonoid));
              var $4 = lookup(dictLookup)(set);
              return function ($5) {
                  return $3($4($5));
              };
          };
...
})(PS["LangaugeConfig"] = PS["LangaugeConfig"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var splitName = function (v) {
      ...
      })(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_NonEmpty_CodeUnits.lastIndexOf(".")(v))(function (idx) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_NonEmpty_CodeUnits.take(idx)(v))(function (name) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_NonEmpty_CodeUnits.drop(idx + 1 | 0)(v))(function (ext) {
                  return Control_Applicative.pure(Data_Maybe.applicativeMaybe)({
                      name: name,
                      ext: new Data_Maybe.Just(ext)
                  });
              });
          });
      }));
  };
  var extension = function ($18) {
      return (function (v) {
          return v.ext;
      })(splitName($18));
  };
...
(function($PS) {
  "use strict";
  $PS["LangaugeConfig"] = $PS["LangaugeConfig"] || {};
  var exports = $PS["LangaugeConfig"];
  var $foreign = $PS["LangaugeConfig"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Functor = $PS["Data.Functor"];
  var Data_Map_Internal = $PS["Data.Map.Internal"];
  ...
  var python = {
      language: $foreign.pythonLanguage,
      symbolQuery: "\x0a(identifier) @identifier \x0a(class_definition (identifier) @type)\x0a(function_definition (identifier) @function)\x0a(import_statement name: (dotted_name) @module)\x0a(aliased_import (dotted_name) @module alias: (identifier) @module)\x0a(import_from_statement module_name: (dotted_name) @module (dotted_name) @value)\x0a",
      navigationalQueries: Data_Map_Internal.empty
  };
  var elm = {
      language: $foreign.elmLanguage,
      symbolQuery: "\x0a(lower_case_identifier) @identifier \x0a(upper_case_identifier) @identifier\x0a(function_declaration_left (lower_case_identifier) @function)\x0a(exposed_value) @function\x0a(lower_pattern) @function\x0a(exposed_type (upper_case_identifier) @type)\x0a(type_declaration (upper_case_identifier) @type)\x0a(type_alias_declaration (upper_case_identifier) @type)\x0a",
      navigationalQueries: Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("type", "[ (type_declaration (upper_case_identifier) @i) (type_alias_declaration (upper_case_identifier) @i) ] @t"), new Data_Tuple.Tuple("identifier", "[ (lower_case_identifier) @i (upper_case_identifier) @i ] @t"), new Data_Tuple.Tuple("function", "(value_declaration (function_declaration_left (lower_case_identifier) @i)) @t"), new Data_Tuple.Tuple("import", "(import_clause) @t"), new Data_Tuple.Tuple("string", "(string_constant_expr) @t"), new Data_Tuple.Tuple("number", "(number_constant_expr) @t") ])
  };
  var fromFileExtension = function (v) {
      if (v === "py") {
          return new Data_Maybe.Just(python);
      };
      if (v === "elm") {
          return new Data_Maybe.Just(elm);
      };
      return Data_Maybe.Nothing.value;
  };
  var fromFileName = function (file) {
      return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Pathy_Name.Name)(Data_String_NonEmpty_Internal.fromString(file)))(function (nes) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Pathy_Name.extension(nes))(function (e) {
              return fromFileExtension(Data_String_NonEmpty_Internal.toString(e));
          });
      });
  };
  var createMatchQuery = function (queryMapping) {
      return function (name) {
          return function (match) {
              return Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(name)(queryMapping))(function (pattern) {
                  return Data_Maybe.Just.create((function () {
                      var $2 = match === "";
                      if ($2) {
                          return pattern;
                      };
                      return "(\x0a" + (pattern + (" " + ("\x0a(#eq? @i \"" + (match + "\")\x0a)"))));
                  })());
              });
          };
      };
  };
  var querySourceMatch = function (queryMapping) {
      return function (name) {
          return function (match) {
              return Data_Maybe.fromMaybe("")(createMatchQuery(queryMapping)(name)(match));
          };
      };
  };
  exports["querySourceMatch"] = querySourceMatch;
...
(function($PS) {
  ...
  var Data_Ring = $PS["Data.Ring"];
  var Data_Semigroup = $PS["Data.Semigroup"];
  var Data_Zipper_ArrayZipper = $PS["Data.Zipper.ArrayZipper"];
  var zipperToClosest = function ($copy_position) {
      return function ($copy_zipper) {
          var $tco_var_position = $copy_position;
          var $tco_done = false;
          var $tco_result;
          function $tco_loop(position, zipper) {
              var distance = function (c) {
                  return function (p) {
                      return Data_Ord.abs(Data_Ord.ordNumber)(Data_Ring.ringNumber)(Data_Int.toNumber(c.node.startPosition.row - p.row | 0) + 0.1 * Data_Int.toNumber(c.node.startPosition.column - p.column | 0));
                  };
              };
              var v = Data_Zipper_ArrayZipper.next(zipper);
              if (v instanceof Data_Maybe.Just) {
                  var $9 = distance(Data_Zipper_ArrayZipper.getFocus(v.value0))(position) < distance(Data_Zipper_ArrayZipper.getFocus(zipper))(position);
                  if ($9) {
                      $tco_var_position = position;
                      $copy_zipper = v.value0;
                      return;
                  };
                  $tco_done = true;
                  return zipper;
              ...
              throw new Error("Failed pattern match at Util (line 32, column 35 - line 34, column 20): " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
              $tco_result = $tco_loop($tco_var_position, $copy_zipper);
          };
          return $tco_result;
      };
  };
      ...
      return function (before) {
          return function (after) {
              return function (content) {
                  return Data_Semigroup.append(dictSemigroup)(before)(Data_Semigroup.append(dictSemigroup)(content)(after));
              };
          };
      };
  };
  var keyValuePair$prime = function (k) {
      return function (v) {
          return "'" + (k + ("':'" + (v + "'")));
      };
  };
  var keyValuePair = function (k) {
      return function (v) {
          return "'" + (k + ("':" + (v + "")));
      };
  };
  var groupOn = function (dictOrd) {
      return function (f) {
          return Data_Foldable.foldr(Data_Foldable.foldableArray)(function (a) {
              return function (b) {
                  return Data_Map_Internal.unionWith(dictOrd)(Data_Semigroup.append(Data_Semigroup.semigroupArray))(b)(Data_Map_Internal.singleton(f(a))([ a ]));
              };
          })(Data_Map_Internal.empty);
      };
  };
  var captureFilterByType = function (typeName) {
      return Data_Array.filter(function ($15) {
          return (function (v) {
              return v === typeName;
          })((function (v) {
              return v.name;
  ...
  exports["keyValuePair'"] = keyValuePair$prime;
  exports["groupOn"] = groupOn;
  exports["zipperToClosest"] = zipperToClosest;
  exports["captureFilterByType"] = captureFilterByType;
})(PS);
(function($PS) {
  "use strict";
  $PS["Talon"] = $PS["Talon"] || {};
  var exports = $PS["Talon"];
  var Control_Alt = $PS["Control.Alt"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var CommandSet = function (x) {
      return x;
  };
  var UpdateSymbols = (function () {
      function UpdateSymbols(value0) {
          this.value0 = value0;
      };
      UpdateSymbols.create = function (value0) {
          return new UpdateSymbols(value0);
      };
  ...
  var ClearSymbols = (function () {
      ...
      ClearSymbols.value = new ClearSymbols();
      return ClearSymbols;
  })();
  ...
  var showRulePart = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Talon (line 116, column 1 - line 119, column 45): " + [ v.constructor.name ]);
  });
  var ruleNewtype = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Rule);
  var ruleShow = new Data_Show.Show((function () {
      var $25 = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ");
      var $26 = Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showRulePart));
      var $27 = Data_Newtype.unwrap(ruleNewtype);
      return function ($28) {
          return $25($26($27($28)));
      };
  })());
  var overrides = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("init", "in it") ]);
  var many1 = function (p) {
      return Control_Apply.apply(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Data_Array.cons)(p))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(p));
  };
  var parseRule = function (s) {
      var wordOrLetter = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_Char_Unicode.isAlpha))(function (first) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_Char_Unicode.isLower)))(function (rest) {
              var $13 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqChar))(rest)([  ]);
              if ($13) {
                  return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Letter.create(Data_Char_Unicode.toUpper(first)));
              };
              return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))(Word.create(Data_String_CodeUnits.fromCharArray(Data_Array.cons(Data_Char_Unicode.toLower(first))(rest))));
          });
      });
      var number = Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))($$Number.create)(many1(Text_Parsing_Parser_Token.digit(Data_Identity.monadIdentity)));
      var garbage = Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_HeytingAlgebra.not(Data_HeytingAlgebra.heytingAlgebraFunction(Data_HeytingAlgebra.heytingAlgebraBoolean))(Data_Char_Unicode.isAlphaNum)));
      var rulePart = Control_Apply.applySecond(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(garbage)(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(number)(wordOrLetter));
      return Text_Parsing_Parser.runParser(s)(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Control_Apply.applyFirst(Text_Parsing_Parser.applyParserT(Data_Identity.monadIdentity))(Data_Functor.map(Text_Parsing_Parser.functorParserT(Data_Identity.functorIdentity))(Rule)(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(rulePart)))(garbage))(Text_Parsing_Parser_String.eof(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)));
  };
  var makeActionString = function (name) {
      return function ($$arguments) {
          return "actions.user." + (name + ("(" + (Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(",")($$arguments) + ")")));
      };
  };
  var commandsFromCaptures = (function () {
      var groupCaptures = (function () {
          var $29 = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray);
          var $30 = Util.groupOn(Data_Ord.ordString)(function (v) {
              return v.name;
          });
          return function ($31) {
              return $29($30($31));
      ...
      var captureToCommand = function (capture) {
          var text$prime = Data_Maybe.fromMaybe(capture.node.text)(Data_Map_Internal.lookup(Data_Ord.ordString)(capture.node.text)(overrides));
          return Control_Apply.apply(Data_Either.applyEither)(Data_Functor.map(Data_Either.functorEither)(Data_Tuple.Tuple.create)(parseRule(text$prime)))(Control_Applicative.pure(Data_Either.applicativeEither)(capture.node.text));
      };
      var $32 = Data_Lens_Setter.over((function () {
          var $35 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
          var $36 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
          return function ($37) {
              return $35($36($37));
          };
      })())(Data_Filterable.filterMap(Data_Filterable.filterableArray)(Data_Either.hush));
      var $33 = Data_Lens_Setter.over((function () {
          var $38 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
          var $39 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
          var $40 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
          return function ($41) {
              return $38($39($40($41)));
          };
      })())(captureToCommand);
      return function ($34) {
          return CommandSet($32($33(groupCaptures($34))));
      };
  })();

  // TODO: Rewrite
  var commandSetShow = new Data_Show.Show(function (commandSet) {
      var toDictionary = (function () {
          var $42 = Util.surround(Data_Semigroup.semigroupString)("{")("}");
          var $43 = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(",");
          return function ($44) {
              return $42($43($44));
          };
      })();
      var g = function (v) {
          return Data_Lens_Setter.over((function () {
              var $45 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
              var $46 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
              var $47 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
              var $48 = Data_Lens_Lens_Tuple["_1"](Data_Profunctor_Strong.strongFn);
              return function ($49) {
                  return $45($46($47($48($49))));
              };
          })())(Data_Show.show(ruleShow))(v);
      };
      var f = function (v) {
          return Util.keyValuePair(v.value0)(toDictionary(Data_Functor.map(Data_Functor.functorArray)(Data_Tuple.uncurry(Util["keyValuePair'"]))(v.value1)));
      };
      return toDictionary(Data_Functor.map(Data_Functor.functorArray)(f)(g(commandSet)));
  });
  var showAction = new Data_Show.Show(function (v) {
      if (v instanceof UpdateSymbols) {
          return makeActionString("update_symbols")([ Data_Show.show(commandSetShow)(v.value0) ]);
      };
      if (v instanceof ClearSymbols) {
          return makeActionString("clear_symbols")([  ]);
      };
      if (v instanceof Navigate) {
          return makeActionString("vim_go_to_position")([ Data_Show.show(Data_Show.showInt)(v.value0), Data_Show.show(Data_Show.showInt)(v.value1) ]);
      };
      if (v instanceof SelectRange) {
          return makeActionString("vim_select_range")(Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(Data_Show.showInt))([ v.value0.row, v.value0.column, v.value1.row, v.value1.column ]));
      };
      throw new Error("Failed pattern match at Talon (line 62, column 1 - line 66, column 117): " + [ v.constructor.name ]);
  });

  // | Since a command to the talon repl
  // | TODO: make better use of the child process API. this is hacky
  var executeCommandUnix = function (statement) {
      var cmd = "echo \"" + (Data_Show.show(showAction)(statement) + "\" | ~/.talon/.venv/bin/repl");
      return function __do() {
          Effect_Console.log(cmd)();
          var process = Node_ChildProcess.spawn("sh")([ "-c", cmd ])(Node_ChildProcess.defaultSpawnOptions)();
          Node_ChildProcess.onError(process)(Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "code";
          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "errno";
          }))(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
              return "syscall";
          }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showString))(Data_Show.showString))))();
          return Node_Stream.onDataString(Node_ChildProcess.stdout(process))(Node_Encoding.UTF8.value)(function (s) {
              return Control_Applicative.when(Effect.applicativeEffect)(Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)("Traceback (most recent call last):")(Data_String_Utils.lines(s)))(function __do() {
  ...
  var executeCommandWindows = function (statement) {
      return function __do() {
          Effect_Console.log(Data_Show.show(showAction)(statement) + (" -> " + "/mnt/c/talon-tss-ipc/cmd"))();
          return Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)("/mnt/c/talon-tss-ipc/cmd")(Data_Show.show(showAction)(statement))();
      };
  };

  // executeUpdate :: CommandSet -> Effect Unit
  // executeUpdate = UpdateSymbols >>> executeCommand
  var executeCommand = function (v) {
      if (v instanceof Windows) {
          return executeCommandWindows;
      };
      if (v instanceof Unix) {
          return executeCommandUnix;
      };
      throw new Error("Failed pattern match at Talon (line 77, column 1 - line 77, column 46): " + [ v.constructor.name ]);
  };
  ...
  exports["commandsFromCaptures"] = commandsFromCaptures;
})(PS);
(function(exports) {
...
})(PS["TreeSitter.Parser"] = PS["TreeSitter.Parser"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TreeSitter.Parser"] = $PS["TreeSitter.Parser"] || {};
  var exports = $PS["TreeSitter.Parser"];
  var $foreign = $PS["TreeSitter.Parser"];
  exports["new"] = $foreign["new"];
...
})(PS["TreeSitter.Query"] = PS["TreeSitter.Query"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TreeSitter.Query"] = $PS["TreeSitter.Query"] || {};
  var exports = $PS["TreeSitter.Query"];
  var $foreign = $PS["TreeSitter.Query"];
  exports["new"] = $foreign["new"];
  exports["captures"] = $foreign.captures;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  ...
  var HTTPure_Version = $PS["HTTPure.Version"];
  var LangaugeConfig = $PS["LangaugeConfig"];
  var Node_Encoding = $PS["Node.Encoding"];
  var Node_FS_Sync = $PS["Node.FS.Sync"];
  var Simple_JSON = $PS["Simple.JSON"];
  var Talon = $PS["Talon"];
  var TreeSitter_Parser = $PS["TreeSitter.Parser"];
  var TreeSitter_Query = $PS["TreeSitter.Query"];
  var Util = $PS["Util"];                
  var positionFromQuery = function (q) {
      var v = Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(q)("column"));
      var v1 = Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(q)("line"));
  ...
  var loggingMiddleware = function (router) {
      return function (request) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(function __do() {
              ...
              Effect_Console.logShow(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                  ...
                  return "query";
              }))(Data_Show.showRecordFieldsNil)(Foreign_Object.showObject(Data_Show.showString)))(Data_Show.showArray(Data_Show.showString)))(HTTPure_Method.showMethod))(HTTPure_Version.showVersion))(HTTPure_Headers.show))(Data_Show.showString)))(request)();
  ...
  var documentSelectParent = function (query) {
      var row = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(query)("line")))(function (v) {
          return v - 1 | 0;
      });
      var column = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(query)("column")))(function (v) {
          return v - 1 | 0;
      });
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
          if (row instanceof Data_Maybe.Just && column instanceof Data_Maybe.Just) {
          ...
          if (maybeNode instanceof Data_Maybe.Nothing) {
              return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(500)("not nice");
          };
          if (maybeNode instanceof Data_Maybe.Just) {
              return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(200)("");
          };
          throw new Error("Failed pattern match at Server (line 105, column 3 - line 107, column 43): " + [ maybeNode.constructor.name ]);
      });
  };
  var documentQuery = function (ref) {
      return function (target) {
          return function (type_) {
              return function (position) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (state) {
                      if (state.maybeDocument instanceof Data_Maybe.Nothing) {
                          return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(400)("No document open");
                      };
                      if (state.maybeDocument instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(TreeSitter_Query["new"](state.maybeDocument.value0.config.language)(LangaugeConfig.querySourceMatch(state.maybeDocument.value0.config.navigationalQueries)(type_)(target))))(function (query) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Util.captureFilterByType("t"))(TreeSitter_Query.captures(query)(state.maybeDocument.value0.tree.rootNode))))(function (captures) {
                                  var maybeZipper = Data_Functor.map(Data_Maybe.functorMaybe)(Util.zipperToClosest(position))(Data_Zipper_ArrayZipper.toArrayZipperFirst(captures));
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(function (v) {
                                      return {
                                          captureZipper: maybeZipper,
                                          maybeDocument: v.maybeDocument,
                                          os: v.os
                                      };
                                  })(ref)))(function () {
                                      if (maybeZipper instanceof Data_Maybe.Nothing) {
                                          return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(500)("No Captures");
                                      };
                                      if (maybeZipper instanceof Data_Maybe.Just) {
                                          return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(200)(Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                                              return "endPosition";
                                              ...
                                              return "type";
                                          }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields)()()())()()())()()())()()())()()()))((Data_Zipper_ArrayZipper.getFocus(maybeZipper.value0)).node));
                                      };
                                      throw new Error("Failed pattern match at Server (line 51, column 7 - line 53, column 81): " + [ maybeZipper.constructor.name ]);
                                  });
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Server (line 43, column 3 - line 53, column 81): " + [ state.maybeDocument.constructor.name ]);
                  });
              };
          };
      };
  };
  var documentOpen = function (ref) {
      return function (file) {
          return function __do() {
              var serverState = Effect_Ref.read(ref)();
              var programSource = Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(file)();
              var maybeConfig = LangaugeConfig.fromFileName(file);
              if (maybeConfig instanceof Data_Maybe.Nothing) {
                  return Effect_Console.log("unknown extension")();
              };
              if (maybeConfig instanceof Data_Maybe.Just) {
                  var tree = Control_Bind.bindFlipped(Effect.bindEffect)(TreeSitter_Parser.parse(programSource))(TreeSitter_Parser["new"](maybeConfig.value0.language))();
                  var document = {
                      tree: tree,
                  ...
                  Effect_Ref.modify_(function (v) {
                      return {
                          maybeDocument: new Data_Maybe.Just(document),
                          captureZipper: v.captureZipper,
                          os: v.os
                      };
                  })(ref)();
                  var query = TreeSitter_Query["new"](maybeConfig.value0.language)(maybeConfig.value0.symbolQuery)();
                  var captures = TreeSitter_Query.captures(query)(tree.rootNode)();
                  return Talon.executeCommand(serverState.os)(new Talon.UpdateSymbols(Talon.commandsFromCaptures(captures)))();
              };
              throw new Error("Failed pattern match at Server (line 61, column 3 - line 70, column 90): " + [ maybeConfig.constructor.name ]);
          };
      };
  };
  var documentCycleResult = function (ref) {
      return function (direction) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serverState) {
              if (serverState.captureZipper instanceof Data_Maybe.Nothing) {
                  return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(400)("No query has been made previously");
              };
              if (serverState.captureZipper instanceof Data_Maybe.Just) {
                  var v = (function () {
                      var $29 = direction === "backward";
                      if ($29) {
                          return new Data_Tuple.Tuple(Data_Zipper_ArrayZipper.prev, Data_Zipper_ArrayZipper.shiftFocusLast);
                      };
                      return new Data_Tuple.Tuple(Data_Zipper_ArrayZipper.next, Data_Zipper_ArrayZipper.shiftFocusFirst);
                  })();
                  var zipper$prime = Data_Maybe.fromMaybe(v.value1(serverState.captureZipper.value0))(v.value0(serverState.captureZipper.value0));
                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(function (v1) {
                      return {
                          captureZipper: new Data_Maybe.Just(zipper$prime),
                          maybeDocument: v1.maybeDocument,
                          os: v1.os
                      };
                  })(ref)))(function () {
                      return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(200)(Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                          ...
                          return "type";
                      }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields)()()())()()())()()())()()())()()()))((Data_Zipper_ArrayZipper.getFocus(zipper$prime)).node));
                  });
              };
              throw new Error("Failed pattern match at Server (line 75, column 3 - line 83, column 63): " + [ serverState.captureZipper.constructor.name ]);
          });
      };
  };
  var server = function (os) {
      var initialState = {
          maybeDocument: Data_Maybe.Nothing.value,
          captureZipper: Data_Maybe.Nothing.value,
          os: os
      };
      var router = function (ref) {
          return function (request) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serversState) {
                  if (request.path.length === 1 && request["path"][0] === "select-parent") {
                      return documentSelectParent(request.query);
                  };
                  if (request.path.length === 1 && request["path"][0] === "cycle-result") {
                      return documentCycleResult(ref)(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("direction"));
                  };
                  if (request.path.length === 1 && request["path"][0] === "document-query") {
                      return documentQuery(ref)(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("target"))(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("type"))(Data_Maybe.fromMaybe({
                          row: 0,
                          column: 0
                      })(positionFromQuery(request.query)));
                  };
                  if (request.path.length === 1 && request["path"][0] === "document-close") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.write(initialState)(ref)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Talon.executeCommand(serversState.os)(Talon.ClearSymbols.value)))(function () {
                              return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)("");
                          });
                      });
                  };
                  if (request.path.length === 1 && request["path"][0] === "document-open") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(documentOpen(ref)(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("file"))))(function () {
                          return HTTPure_Response.ok(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)("");
                      });
                  };
      ...
      return function __do() {
          var ref = Effect_Ref["new"](initialState)();
          return HTTPure_Server.serve(8080)(loggingMiddleware(router(ref)))(Effect_Console.log("Server now up on port 8080"))();
      };
  };
...
})(PS["TreeSitter.Cursor"] = PS["TreeSitter.Cursor"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TreeSitter.Cursor"] = $PS["TreeSitter.Cursor"] || {};
  var exports = $PS["TreeSitter.Cursor"];
  var $foreign = $PS["TreeSitter.Cursor"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect = $PS["Effect"];
  var gotoChildAtIndex = function (index) {
      return function (cursor) {
          return Effect.whileE($foreign.gotoFirstChildForIndex(index)(cursor))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
      };
  };
  exports["gotoChildAtIndex"] = gotoChildAtIndex;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TreeSitter.Node"] = $PS["TreeSitter.Node"] || {};
  var exports = $PS["TreeSitter.Node"];
  var Data_Nullable = $PS["Data.Nullable"];
  var Data_Unit = $PS["Data.Unit"];                
  var walk = function (node) {
      return node.walk(Data_Unit.unit);
  };
  var toString = function (node) {
      return node.toString(Data_Unit.unit);
  };
  var parent = function (node) {
      return Data_Nullable.toMaybe(node.parent);
  };
  exports["walk"] = walk;
...
(function($PS) {
  ...
  var Talon = $PS["Talon"];
  var TreeSitter_Cursor = $PS["TreeSitter.Cursor"];
  var TreeSitter_Node = $PS["TreeSitter.Node"];
  var TreeSitter_Parser = $PS["TreeSitter.Parser"];                
  var testCursor = function (node) {
      var cursor = TreeSitter_Node.walk(node);
      return function __do() {
          TreeSitter_Cursor.gotoChildAtIndex(451)(cursor)();
          return Effect_Console.logShow(Data_Show.showString)(TreeSitter_Node.toString(cursor.currentNode))();
      };
  };
  var testCaptures = function (captures) {
      return Data_Foldable.for_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(captures)(function (capture) {
          return Effect_Console.logShow(Data_Maybe.showMaybe(Data_Show.showString))(Data_Functor.map(Data_Maybe.functorMaybe)(TreeSitter_Node.toString)(Control_Bind.bindFlipped(Data_Maybe.bindMaybe)(TreeSitter_Node.parent)(TreeSitter_Node.parent(capture.node))));
      });
  };
  var debug = function __do() {
      var parser = TreeSitter_Parser["new"](LangaugeConfig.python.language)();
      var tree = TreeSitter_Parser.parse("x = 5")(parser)();
      Effect_Console.logShow(Data_Show.showString)(TreeSitter_Node.toString(tree.rootNode))();
  ...
  var main = (function () {
      ...
      if (args.length === 1 && args[0] === "windows") {
          return Control_Apply.applySecond(Effect.applyEffect)(Server.server(Talon.Windows.value))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
      };
      return Control_Apply.applySecond(Effect.applyEffect)(Server.server(Talon.Unix.value))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
  })();
  exports["debug"] = debug;
  exports["testCaptures"] = testCaptures;
  exports["testCursor"] = testCursor;
  exports["args"] = args;
  exports["main"] = main;
