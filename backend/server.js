...
(function($PS) {
  ...
  var q = "(field_type name: (lower_case_identifier) @name)";
      return function __do() {
          ...
          var query = TreeSitter_Query["new"](TreeSitter.elmLanguage)(q)();
          ...
          return function (type_) {
              return function (position) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (state) {
                      ...
                      throw new Error("Failed pattern match at Main (line 92, column 3 - line 103, column 81): " + [ state.maybeTree.constructor.name ]);
                  });
              };
          };
      };
