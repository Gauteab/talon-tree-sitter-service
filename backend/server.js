  ...
  var zipperToClosest = function ($copy_position) {
      return function ($copy_zipper) {
          ...
          function $tco_loop(position, zipper) {
              ...
              throw new Error("Failed pattern match at Util (line 34, column 35 - line 36, column 20): " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
...
(function($PS) {
  ...
  var positionFromQuery = function (query) {
      var row = Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(query)("line"));
      var column = Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(query)("column"));
      if (row instanceof Data_Maybe.Just && column instanceof Data_Maybe.Just) {
          return new Data_Maybe.Just({
              row: row.value0 - 1 | 0,
              column: column.value0 - 1 | 0
          });
      };
      return Data_Maybe.Nothing.value;
  };
  ...
  var elmQuerySource = "\x0a(lower_case_identifier) @identifier \x0a(upper_case_identifier) @identifier\x0a(function_declaration_left (lower_case_identifier) @function)\x0a(exposed_value) @function\x0a(lower_pattern) @function\x0a(exposed_type (upper_case_identifier) @type)\x0a(type_declaration (upper_case_identifier) @type)\x0a(type_alias_declaration (upper_case_identifier) @type)\x0a";
  var documentSelectParent = function (query) {
      ...
      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
          ...
          throw new Error("Failed pattern match at Main (line 149, column 3 - line 151, column 43): " + [ maybeNode.constructor.name ]);
      });
  };
  ...
  var documentCycleResult = function (ref) {
      return function (direction) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serverState) {
              ...
              throw new Error("Failed pattern match at Main (line 119, column 3 - line 127, column 63): " + [ serverState.captureZipper.constructor.name ]);
          });
      };
  };
          ...
          return function (type_) {
              return function (position) {
                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (state) {
                      if (state.maybeTree instanceof Data_Maybe.Nothing) {
                          return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(400)("No document open");
                      };
                      if (state.maybeTree instanceof Data_Maybe.Just) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(TreeSitter_Query["new"](TreeSitter.elmLanguage)(elmQuerySourceMatch(type_)(target))))(function (query) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(Util.captureFilterByType("t"))(TreeSitter_Query.captures(query)(state.maybeTree.value0.rootNode))))(function (captures) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(function (v) {
                                      ...
                                      throw new Error("Failed pattern match at Main (line 102, column 7 - line 104, column 81): " + [ maybeZipper.constructor.name ]);
                                  });
                              });
                          });
                      };
                      throw new Error("Failed pattern match at Main (line 94, column 3 - line 104, column 81): " + [ state.maybeTree.constructor.name ]);
                  });
              };
          };
      };
  ...
  exports["documentCycleResult"] = documentCycleResult;
  exports["documentSelectParent"] = documentSelectParent;
