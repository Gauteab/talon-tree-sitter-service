...
(function($PS) {
  ...
  var showRulePart = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Talon (line 118, column 1 - line 121, column 45): " + [ v.constructor.name ]);
  });
  ...
  var showAction = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Talon (line 64, column 1 - line 68, column 117): " + [ v.constructor.name ]);
  });
  var talonExecuteCommandUnix = function (statement) {
  ...
  var talonExecuteCommandWindows = function (statement) {
      return function __do() {
          var home = $foreign.homedir();
          var path = home + "/.talon-tss-ipc/cmd";
          return Node_FS_Sync.writeTextFile(Node_Encoding.UTF8.value)(path)(Data_Show.show(showAction)(statement))();
      };
  };
  var talonExecuteCommand = function (v) {
      if (v instanceof Windows) {
          return talonExecuteCommandWindows;
      };
      if (v instanceof Unix) {
          return talonExecuteCommandUnix;
      };
      throw new Error("Failed pattern match at Talon (line 79, column 1 - line 79, column 51): " + [ v.constructor.name ]);
  };
  exports["UpdateSymbols"] = UpdateSymbols;
  exports["ClearSymbols"] = ClearSymbols;
  exports["Windows"] = Windows;
  exports["Unix"] = Unix;
  exports["talonExecuteCommand"] = talonExecuteCommand;
...
})(PS["TreeSitter"] = PS["TreeSitter"] || {});
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["TreeSitter"] = $PS["TreeSitter"] || {};
  var exports = $PS["TreeSitter"];
  var $foreign = $PS["TreeSitter"];
  exports["elmLanguage"] = $foreign.elmLanguage;
})(PS);
(function(exports) {
...
(function($PS) {
  ...
  var child = function (i) {
      return function (n) {
          return Data_Array.index(children(n))(i);
      };
  };
  exports["walk"] = walk;
...
(function($PS) {
      ...
      return function ($copy_zipper) {
          ...
          function $tco_loop(position, zipper) {
              var distance = function (c) {
                  return function (p) {
                      return Data_Ord.abs(Data_Ord.ordInt)(Data_Ring.ringInt)(c.node.startPosition.row - p.row | 0);
                  };
              };
              var v = Data_Zipper_ArrayZipper.next(zipper);
              if (v instanceof Data_Maybe.Just) {
                  var $15 = distance(Data_Zipper_ArrayZipper.getFocus(v.value0))(position) < distance(Data_Zipper_ArrayZipper.getFocus(zipper))(position);
                  if ($15) {
              ...
              throw new Error("Failed pattern match at Main (line 145, column 35 - line 147, column 20): " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var queryMapping = Data_Map_Internal.fromFoldable(Data_Ord.ordString)(Data_Foldable.foldableArray)([ new Data_Tuple.Tuple("type", "[ (type_declaration (upper_case_identifier) @i) (type_alias_declaration (upper_case_identifier) @i) ] @t"), new Data_Tuple.Tuple("identifier", "[ (lower_case_identifier) @i (upper_case_identifier) @i ] @t"), new Data_Tuple.Tuple("function", "(value_declaration (function_declaration_left (lower_case_identifier) @i)) @t"), new Data_Tuple.Tuple("import", "(import_clause) @t") ]);
  var printTree = function ($58) {
      return Effect_Console.log(TreeSitter_Node.toString((function (v) {
          return v.rootNode;
      })($58)));
  };
  var positionFromQuery = function (query) {
  ...
  var importAs = function (n) {
      var v = Control_Bind.bind(Data_Maybe.bindMaybe)(TreeSitter_Node.child(2)(n))(TreeSitter_Node.child(1));
      var v1 = TreeSitter_Node.child(1)(n);
      if (v1 instanceof Data_Maybe.Just && v instanceof Data_Maybe.Just) {
          return v1.value0.text + ("-" + v.value0.text);
      };
      return "";
  };
  var getCaptures = function (language) {
      return function (querySource) {
          return function (programSource) {
              return function __do() {
                  var tree = Control_Bind.bindFlipped(Effect.bindEffect)(TreeSitter_Parser.parse(programSource))(TreeSitter_Parser["new"](TreeSitter.elmLanguage))();
                  var query = TreeSitter_Query["new"](TreeSitter.elmLanguage)(querySource)();
                  return TreeSitter_Query.captures(query)(tree.rootNode)();
              };
          };
      };
  };
  var elmQuerySource = "\x0a(lower_case_identifier) @identifier \x0a(upper_case_identifier) @identifier\x0a\x0a(function_declaration_left (lower_case_identifier) @function)\x0a(exposed_value) @function\x0a(lower_pattern) @function\x0a(union_variant (upper_case_identifier) @constructor)\x0a\x0a(exposed_type (upper_case_identifier) @type)\x0a(type_declaration (upper_case_identifier) @type)\x0a(type_alias_declaration (upper_case_identifier) @type)\x0a\x0a(record_pattern (_ (lower_case_identifier) @record-field))\x0a(field_access_expr (lower_case_identifier) @record-field)\x0a(field_type name: (lower_case_identifier) @record-field)\x0a(field name: (lower_case_identifier) @record-field)\x0a\x0a(import_clause (upper_case_qid (upper_case_identifier) @module))\x0a(import_clause (as_clause (upper_case_identifier) @module-alias))\x0a(import_clause (as_clause)) @import-with-alias\x0a  ";
      ...
      return function (file) {
          return function __do() {
              ...
              Effect_Ref.modify_(function (v) {
                  return {
                      maybeTree: new Data_Maybe.Just(tree),
                      captureZipper: v.captureZipper,
                      os: v.os
                  };
              })(ref)();
              var query = TreeSitter_Query["new"](TreeSitter.elmLanguage)(elmQuerySource)();
              var captures = TreeSitter_Query.captures(query)(tree.rootNode)();
              return Talon.talonExecuteCommand(serverState.os)(new Talon.UpdateSymbols(Talon.commandsFromCaptures(captures)))();
          };
      };
  };
  var debug = function __do() {
      var programSource = Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)("../Example.elm")();
      var parser = TreeSitter_Parser["new"](TreeSitter.elmLanguage)();
      var tree = TreeSitter_Parser.parse(programSource)(parser)();
      var query = TreeSitter_Query["new"](TreeSitter.elmLanguage)("(field_type name: (lower_case_identifier) @name)")();
      testCursor(tree.rootNode)();
      return Data_Unit.unit;
  };
  var cycleResult = function (ref) {
      return function (direction) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serverState) {
              ...
              throw new Error("Failed pattern match at Main (line 164, column 3 - line 172, column 63): " + [ serverState.captureZipper.constructor.name ]);
          });
      };
  };
  var createMatchQuery = function (name) {
  ...
  var elmQuerySourceMatch = function (name) {
      return function (match) {
          return Data_Maybe.fromMaybe("")(createMatchQuery(name)(match));
      };
  };
  var captureFilterByType = function (typeName) {
      return Data_Array.filter(function ($59) {
          return (function (v) {
              return v === typeName;
          })((function (v) {
              return v.name;
          ...
          return function (target) {
              return function (type_) {
                  return function (position) {
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(file)))(function (elmSource) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(captureFilterByType("t"))(getCaptures(TreeSitter.elmLanguage)(elmQuerySourceMatch(type_)(target))(elmSource))))(function (captures) {
                              var maybeZipper = Data_Zipper_ArrayZipper.toArrayZipperFirst(captures);
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(function (v) {
                                  ...
                                  if (maybeZipper instanceof Data_Maybe.Just) {
                                      return HTTPure_Response.response(Effect_Aff_Class.monadAffAff)(HTTPure_Body.bodyString)(200)(Simple_JSON.writeJSON(Simple_JSON.recordWriteForeign()(Simple_JSON.consWriteForeignFields(new Data_Symbol.IsSymbol(function () {
                                          ...
                                          return "type";
                                      }))(Simple_JSON.writeForeignString)(Simple_JSON.nilWriteForeignFields)()()())()()())()()())()()())()()()))((Data_Zipper_ArrayZipper.getFocus(zipperToClosest(position)(maybeZipper.value0))).node));
                                  };
                                  throw new Error("Failed pattern match at Main (line 140, column 3 - line 142, column 102): " + [ maybeZipper.constructor.name ]);
                              });
                          });
                      });
                  };
  ...
  var server = function (os) {
      var initialState = {
          maybeTree: Data_Maybe.Nothing.value,
          ...
          return function (request) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serversState) {
                  if (request.path.length === 1 && request["path"][0] === "select-parent") {
                      var row = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("line")))(function (v) {
                          return v - 1 | 0;
                      });
                      var column = Data_Functor.mapFlipped(Data_Maybe.functorMaybe)(Data_Int.fromString(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("column")))(function (v) {
                          return v - 1 | 0;
                      });
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 220, column 9 - line 222, column 49): " + [ maybeNode.constructor.name ]);
                      });
                  };
                  if (request.path.length === 1 && request["path"][0] === "cycle-result") {
                      return cycleResult(ref)(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("direction"));
                  };
                  if (request.path.length === 1 && request["path"][0] === "document-query") {
                      return documentQuery(ref)(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("file"))(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("target"))(HTTPure_Lookup.at(Data_Monoid.monoidString)(HTTPure_Lookup.lookupObject)(request.query)("type"))(Data_Maybe.fromMaybe({
                          row: 0,
                          column: 0
                  ...
                  if (request.path.length === 1 && request["path"][0] === "document-close") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.write(initialState)(ref)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Talon.talonExecuteCommand(serversState.os)(Talon.ClearSymbols.value)))(function () {
  ...
  var main = (function () {
      ...
      if (args.length === 1 && args[0] === "windows") {
          return Control_Apply.applySecond(Effect.applyEffect)(server(Talon.Windows.value))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
      };
      return Control_Apply.applySecond(Effect.applyEffect)(server(Talon.Unix.value))(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
  })();
  exports["queryMapping"] = queryMapping;
  exports["createMatchQuery"] = createMatchQuery;
  exports["elmQuerySourceMatch"] = elmQuerySourceMatch;
  exports["elmQuerySource"] = elmQuerySource;
  ...
  exports["documentOpen"] = documentOpen;
  exports["cycleResult"] = cycleResult;
  exports["loggingMiddleware"] = loggingMiddleware;
  exports["server"] = server;
  exports["positionFromQuery"] = positionFromQuery;
  exports["debug"] = debug;
