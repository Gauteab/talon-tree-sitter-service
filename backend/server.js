...
(function($PS) {
  ...
  var showRulePart = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Talon (line 97, column 1 - line 100, column 45): " + [ v.constructor.name ]);
  });
  var ruleNewtype = new Data_Newtype.Newtype(function (n) {
      return n;
  }, Rule);
  var ruleShow = new Data_Show.Show((function () {
      var $23 = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ");
      var $24 = Data_Functor.map(Data_Functor.functorArray)(Data_Show.show(showRulePart));
      var $25 = Data_Newtype.unwrap(ruleNewtype);
      return function ($26) {
          return $23($24($25($26)));
      };
  })());
  ...
  var parseRule = function (s) {
      var wordOrLetter = Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_Char_Unicode.isAlpha))(function (first) {
          return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Data_Array.many(Text_Parsing_Parser.alternativeParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser.lazyParserT)(Text_Parsing_Parser_String.satisfy(Text_Parsing_Parser_String.stringLikeString)(Data_Identity.monadIdentity)(Data_Char_Unicode.isLower)))(function (rest) {
              var $12 = Data_Eq.eq(Data_Eq.eqArray(Data_Eq.eqChar))(rest)([  ]);
              if ($12) {
  ...
  var commandsFromCaptures = (function () {
      var groupCaptures = (function () {
          var $27 = Data_Map_Internal.toUnfoldable(Data_Unfoldable.unfoldableArray);
          var $28 = Util.groupOn(Data_Ord.ordString)(function (v) {
              return v.name;
          });
          return function ($29) {
              return $27($28($29));
      ...
      var $30 = Data_Lens_Setter.over((function () {
          var $33 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
          var $34 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
          return function ($35) {
              return $33($34($35));
          };
      })())(Data_Filterable.filterMap(Data_Filterable.filterableArray)(Data_Either.hush));
      var $31 = Data_Lens_Setter.over((function () {
          var $36 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
          var $37 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
      ...
      return function ($32) {
          return CommandSet($30($31(groupCaptures($32))));
      };
  })();
  var commandSetShow = new Data_Show.Show(function (commandSet) {
      var toDictionary = (function () {
          var $40 = Util.surround(Data_Semigroup.semigroupString)("{")("}");
          var $41 = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(",");
          return function ($42) {
              return $40($41($42));
          };
      })();
      var g = function (v) {
          return Data_Lens_Setter.over((function () {
              var $43 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
              var $44 = Data_Lens_Lens_Tuple["_2"](Data_Profunctor_Strong.strongFn);
              var $45 = Data_Lens_Traversal.traversed(Data_Traversable.traversableArray)(Data_Lens_Internal_Wander.wanderFunction);
              var $46 = Data_Lens_Lens_Tuple["_1"](Data_Profunctor_Strong.strongFn);
              return function ($47) {
  ...
  var showAction = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Talon (line 61, column 1 - line 65, column 117): " + [ v.constructor.name ]);
  });
  var talonExecuteCommand = function (statement) {
  ...
  var talonExecuteUpdate = function ($48) {
      return talonExecuteCommand(UpdateSymbols.create($48));
  };
  exports["ClearSymbols"] = ClearSymbols;
  exports["talonExecuteUpdate"] = talonExecuteUpdate;
...
(function($PS) {
  ...
  var zipperToClosest = function ($copy_position) {
      return function ($copy_zipper) {
          ...
          function $tco_loop(position, zipper) {
              ...
              throw new Error("Failed pattern match at Main (line 146, column 35 - line 148, column 20): " + [ v.constructor.name ]);
          };
          while (!$tco_done) {
  ...
  var updateSymbols = function (file) {
      return function __do() {
          var elmSource = Effect_Class.liftEffect(Effect_Class.monadEffectEffect)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(file))();
          var captures = getCaptures(TreeSitter.elmLanguage)(elmQuerySource)(elmSource)();
          return Talon.talonExecuteUpdate(Talon.commandsFromCaptures(captures))();
      };
  };
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(file)))(function (elmSource) {
                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Functor.map(Effect.functorEffect)(captureFilterByType("t"))(getCaptures(TreeSitter.elmLanguage)(elmQuerySourceMatch(type_)(target))(elmSource))))(function (captures) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.modify_(function (v) {
                                  ...
                                  throw new Error("Failed pattern match at Main (line 141, column 3 - line 143, column 102): " + [ maybeZipper.constructor.name ]);
                              });
                          });
                      });
                  };
              ...
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.read(ref)))(function (serversState) {
                  if (request.path.length === 1 && request["path"][0] === "select-parent") {
                      ...
                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                          ...
                          throw new Error("Failed pattern match at Main (line 219, column 9 - line 221, column 49): " + [ maybeNode.constructor.name ]);
                      });
                  };
                  ...
                  if (request.path.length === 1 && request["path"][0] === "document-close") {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Ref.write(initialState)(ref)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Talon.talonExecuteCommand(Talon.ClearSymbols.value)))(function () {
  ...
  var main = (function () {
      ...
      return Control_Apply.applySecond(Effect.applyEffect)(server)(Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit));
  })();
